...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        String cipherText1 = transpositionCipher.encryption(transpositionKey,"Consider that for a moment: everything we see around us is assumed to have had a cause",false);
        ...
        DictionaryHC.HillClimb(cipherText2, Misc.Language.EN);
    }
}
